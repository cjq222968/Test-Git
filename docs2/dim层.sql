...
drop table if exists tms_dim.dim_complex_full;
create external table tms_dim.dim_complex_full(
  ...
  district_name string comment '区（县）名称'
    ...
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_complex_full'
...
from (select id,
     ...
     (select
          ...
          complex_id
      from ods_express_courier_complex where dt='2025-07-13' and is_deleted='0'
      group by complex_id
     ) complex_courier
     on complex_info.id = complex_courier.complex_id;

select * from tms_dim.dim_complex_full;

drop table if exists tms_dim.dim_organ_full;
create external table tms_dim.dim_organ_full(
    ...
    partitioned by (dt string comment '统计日期')
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_organ_full'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_organ_full;

drop table if exists tms_dim.dim_region_full;
create external table tms_dim.dim_region_full(
    ...
    partitioned by (dt string comment '统计日期')
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_region_full'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_region_full;


drop table if exists tms_dim.dim_express_courier_full;
create external table tms_dim.dim_express_courier_full(
    ...
    partitioned by (dt string comment '统计日期')
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_express_courier_full'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_express_courier_full;


drop table if exists tms_dim.dim_shift_full;
create external table tms_dim.dim_shift_full(
    ...
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_shift_full'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_shift_full;



drop table if exists tms_dim.dim_truck_driver_full;
create external table tms_dim.dim_truck_driver_full(
    ...
    partitioned by (dt string comment '统计日期')
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_truck_driver_full'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_truck_driver_full;


drop table if exists tms_dim.dim_truck_full;
create external table tms_dim.dim_truck_full(
    ...
    partitioned by (dt string comment '统计日期')
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_truck_full'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_truck_full;


drop table if exists tms_dim.dim_user_zip;
create external table tms_dim.dim_user_zip(
    ...
    partitioned by (dt string comment '统计日期')
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_user_zip'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_user_zip;

drop table if exists tms_dim.dim_user_address_zip;
create external table tms_dim.dim_user_address_zip(
    ...
    partitioned by (dt string comment '统计日期')
    stored as orc
    location '/bigdata_warehouse/tms/tms_dim/dim_user_address_zip'
    tblproperties('orc.compress'='snappy');
...
select * from tms_dim.dim_user_address_zip;